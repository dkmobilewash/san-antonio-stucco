...
export const locations: Location[] = [
  ...
  },
  {
    ...
    extendedContent: [
      ...
      'Whether you are building a new custom home, restoring a historic Hauptstrasse property, or dealing with cracks that have appeared on a 10-year-old house, the same standards apply: honest diagnosis, durable materials, and a finish that matches the existing texture exactly. Take a look at our dedicated <a href="/stucco-repairs">stucco repair page</a> for details on how we handle Hill Country crack and water-damage repairs, or visit our <a href="/">homepage</a> to see the full range of services we provide across the greater San Antonio metro.',
    ],
  },
  {
    slug: 'new-braunfels',
    ...
    extendedContent: [
      ...
      'If you are weighing whether to repair existing damage or pull and replace a wall, the right answer depends on what is happening behind the surface. Our <a href="/stucco-repairs">stucco repair team</a> handles full inspections across New Braunfels and Comal County and will tell you honestly when repair is enough and when it is not. You can also visit our <a href="/">homepage</a> to see the broader range of installation, replacement, and EIFS services we offer throughout the area.',
    ],
  },
  {
    slug: 'schertz',
  ...
  },
  {
    ...
    extendedContent: [
      ...
      'We serve all of Live Oak with the same professional crews that handle our San Antonio, Schertz, and Universal City work — there is no quality difference because of geography. If your stucco is showing cracks, staining, or chalking, our <a href="/stucco-repairs">stucco repair specialists</a> will come out for a free inspection and give you an honest assessment of what needs to be done. Visit our <a href="/">homepage</a> to browse the full range of services we offer, from targeted repairs to full installation and replacement.',
    ],
  },
  {
    slug: 'universal-city',
    ...
    extendedContent: [
      ...
      'Whether you are a military family getting a home ready for a PCS move, an investor maintaining a rental property near the base, or a long-time Universal City resident who wants to update an aging exterior, we deliver the same professional quality on every project. Our <a href="/stucco-repairs">stucco repair page</a> covers the common repair scenarios we handle throughout the area, and you can browse our full service lineup on the <a href="/">homepage</a>. Free estimates, no pressure, and we work within military timelines.',
    ],
  },
  {
    slug: 'leon-valley',
