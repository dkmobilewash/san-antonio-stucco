...
export default function BlogPostPage() {
  ...
  const seoMeta = useMemo(() => {
    ...
    const titles: Record<string, string> = {
      ...
      'eifs-vs-traditional-stucco-differences': 'EIFS vs Stucco | Cost, Differences & Comparison',
      'protecting-stucco-from-texas-heat': 'Protecting Stucco from Texas Heat | Maintenance Tips',
      'stucco-maintenance-checklist-san-antonio': 'Stucco Maintenance Checklist for San Antonio Homes',
      ...
      'how-much-does-it-cost-to-stucco-a-1000-sq-ft-house': 'Cost to Stucco a 1,000 Sq Ft House (2026 Prices)',
      ...
      'what-is-stucco': 'What Is Stucco? | Materials, Process & Types Guide',
      'what-are-the-downsides-of-stucco': 'Downsides of Stucco: 5 Honest Pros & Cons',
    ...
    const descriptions: Record<string, string> = {
      ...
      'eifs-vs-traditional-stucco-differences': 'EIFS vs stucco compared side by side — materials, moisture handling, cost, durability & maintenance. San Antonio stucco experts break down every difference.',
      ...
      'stucco-repair-near-me-san-antonio-guide': 'Searching stucco repair near me in San Antonio? What to check before you hire, real repair costs, and the red flags that signal a bad contractor.',
      ...
      'how-much-does-it-cost-to-stucco-a-1000-sq-ft-house': 'What it costs to stucco a 1,000 sq ft house in San Antonio in 2026 — price per square foot, what is included, and what pushes the number up.',
      ...
      'what-is-stucco': 'What is stucco and what is it made of? Plain-language guide to stucco materials, the three-coat process & why it dominates San Antonio home exteriors.',
      'what-are-the-downsides-of-stucco': 'The real downsides of stucco — cracking, moisture risk, repair cost — and exactly how San Antonio homeowners minimize each one before they build.',
