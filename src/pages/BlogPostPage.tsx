...
export default function BlogPostPage() {
  ...
  const seoMeta = useMemo(() => {
    ...
    const titles: Record<string, string> = {
      ...
      'what-are-the-downsides-of-stucco': 'Stucco Pros and Cons | Honest Homeowner Guide',
    ...
    const descriptions: Record<string, string> = {
      ...
      'what-are-the-downsides-of-stucco': 'Stucco pros and cons for San Antonio homes — durability, cost, climate fit, cracking & moisture risk. Honest guide from local stucco experts.',
